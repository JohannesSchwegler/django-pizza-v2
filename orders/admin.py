...
class OrderAdmin(admin.ModelAdmin):
    list_display = ("user", "order_sent", "order_completed", "_get_pizzas_list", "_get_subs_list",
                    "_get_pastas_list", "_get_salads_list", "_get_dinner_platters_list", "_get_order_price")
    readonly_fields = ("_get_pizzas_list", "_get_subs_list", "_get_pastas_list",
                       "_get_salads_list", "_get_dinner_platters_list", "_get_order_price")
...
admin.site.register(Pizza, PizzaAdmin)  # Pizza
